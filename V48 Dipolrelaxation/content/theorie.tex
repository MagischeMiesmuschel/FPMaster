...
\begin{figure}
    ...
    \caption{Aufbau des Versuchs mit Beschriftung der wichtigsten Teile.}
    \label{fig:aufbau}
\end{figure}
Als Probe für diesen Versuch wurde Kbr verwendet, welches mit Strontium dotiert ist.
Diese ist auf dem Boden des Rezipenten befestigt, mit einer Metallplatte auf ihr.
Diese bildet einen Plattenkondensator mit dem Boden des Behälters (siehe Skizze \ref{fig:skizze}).
Im Rezipenten wird durch eine Drehschieberpumpe ein Vakuum von $10^{-2}\,$mbar aufrecht erhalten, weil die Kbr Probe hygroskopisch ist.
Die Temperatur der Probe kann über ein Thermoelement erhaten werden.
Zum aufheizen wird eine im Boen des Behälters befindliche Heizspule benutzt und zum abkühlen wird der Kupfer Kühlfinger in flüssigen Stickstoff getaucht.
\begin{figure}
    \centering
...
Die Probe wird als erstes bei einer Temperatur von ca. $320\,$K polarisiert durch anlegen einer SPannung von $950\,$V an den Plattenkondensator über einen Zeitraum von ca. $15$ Minuten.
Diese Zeit muss groß gegen die Relaxiationszeit sein.
Danach wird die Probe mit dem flüssigen Stickstoff auf ungefähr $220\,$K abgekühlt und der Kondensator für $5$ Minuten durch Kurzschließen entladen.
...
Nach Abschluss dieser Messung wird der komplette Vorgang nochmals wiederholt mit einer anderen, aber auch konstanten Heizrate von bis zu $2\,$K pro Minute.